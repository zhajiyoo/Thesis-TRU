...
**October 2025:** After conducting background research and reviewing relevant literature, finalized the thesis topic as sample size re-estimation for incomplete data.

**November 2025:** Developed initial code in Jupyter Notebook and tested the algorithm on a simple dataset to examine its feasibility.

**December 2025:** Organized and summarized the papers reviewed during the previous term and began writing the methodology section.

**January 2026:** Continued writing the literature review and obtained preliminary results from simulated datasets.

**February--March 2026:** Wrote the results section. Progress was slightly delayed due to preparation for the CELPIP test and planning for the PGWP application.
